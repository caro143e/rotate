...
function buildCartMenu() {
  document.querySelector(".cart_title").textContent = shops.title.rendered;
  document.querySelector('.cart_pic').src = shops.produktbillede[0].guid;
  document.querySelector(".cart_pris").textContent = shops.prisdk;
  document.querySelector(".cart_farve").textContent = 'COLOUR: ' + shops.color;
  document.querySelector(".cart_size").textContent = 'Size: ' + active_size;
  document.querySelector(".cart_subtotal").textContent = 'SUBTOTAL: ' + shops.prisdk;
}
